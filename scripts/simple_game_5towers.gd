...
var ui_buttons = []
var frozen_enemies = {}  # {enemy_id: freeze_end_time}
var laser_targets = {}  # {tower_id: [enemies in range]}
var next_enemy_id = 0
...
func create_ui():
	...
	btn1.custom_minimum_size = Vector2(0, 40)
	...
	btn3.custom_minimum_size = Vector2(0, 40)
	...
	btn_gun.custom_minimum_size = Vector2(0, 40)
	...
	btn_freeze.custom_minimum_size = Vector2(0, 40)
	...
	btn_laser.custom_minimum_size = Vector2(0, 40)
	...
	btn2.custom_minimum_size = Vector2(0, 40)
